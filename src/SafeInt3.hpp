...
#ifndef CPP_ASSERT
#define CPP_ASSERT(e) typedef char __CPP_ASSERT__[(e)?1:-1]
#endif

// Let's test some assumptions
// We're assuming two's complement negative numbers
CPP_ASSERT( -1 == static_cast<int>(0xffffffff) );
...
{
public:
    CPP_ASSERT( NumericType<T>::isInt );
    enum
    {
        isSigned  = ( (T)(-1) < 0 ),
        is64Bit   = ( sizeof(T) == 8 ),
...
public:
    ...
    static bool Multiply( const T& t, const U& u, T& ret ) SAFEINT_NOTHROW
    {
        CPP_ASSERT( IntTraits<T>::isUint64 && IntTraits<U>::isUint64 );
...
public:
    ...
    static bool Multiply( const T& t, const U& u, T& ret ) SAFEINT_NOTHROW
    {
        CPP_ASSERT( IntTraits<T>::isUint64 );
        unsigned __int64 t1 = t;
...
public:
    ...
    static bool Multiply(const T& t, const U& u, T& ret) SAFEINT_NOTHROW
    {
        CPP_ASSERT( IntTraits<U>::isUint64 );
        unsigned __int64 u1 = u;
        unsigned __int32 tmp;
...
public:
    ...
    static bool Multiply(const T& t, const U& u, T& ret) SAFEINT_NOTHROW
    {
        CPP_ASSERT( IntTraits<T>::isUint64 && IntTraits<U>::isInt64 );
        unsigned __int64 t1 = t;
        __int64          u1 = u;
...
public:
    ...
    static bool Multiply(const T& t, const U& u, T& ret) SAFEINT_NOTHROW
    {
        CPP_ASSERT( IntTraits<U>::isInt64 );
        __int64          u1 = u;
        unsigned __int32 tmp;
...
public:
    ...
    static bool Multiply( const T& t, const U& u, T& ret ) SAFEINT_NOTHROW
    {
        CPP_ASSERT( IntTraits<T>::isInt64 );
        __int64          t1 = t;
...
public:
    ...
    static bool Multiply( const T& t, const U& u, T& ret ) SAFEINT_NOTHROW
    {
        CPP_ASSERT( IntTraits<T>::isInt64 && IntTraits<U>::isInt64 );
        __int64          t1 = t;
        __int64          u1 = u;
...
public:
    ...
    static bool Multiply( const T& t, const U& u, T& ret ) SAFEINT_NOTHROW
    {
        CPP_ASSERT( IntTraits<T>::isInt64 && IntTraits<U>::isUint64 );
        __int64          t1 = t;
        unsigned __int64 u1 = u;
